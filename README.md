...
This project, undertaken by Team Evoastra, aims to explore and implement a robust image captioning system. The project is a collaborative effort under the leadership of Mohd Meheran, with Mohd Saad Ahmed Sohaib serving as Co-Lead. Our goal is to contribute to this dynamic field by developing a model that not only accurately describes visual content but also captures the contextual nuances essential for human-like understanding.
​
## **Project Goals**
